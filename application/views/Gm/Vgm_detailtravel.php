...
<?php if($hist == NULL){?>
    <div class="container my-3" style="background-color: white;">
        <center>
            ...
            <a href="<?= base_url('gmhome/approval')?>" class='btn btn-outline-warning btn-lg my-3'>Back</a>
        </center>
    </div>
<?php } else{?>
    <div class="container my-3" style="background-color: white;">
        <a href="<?= base_url('gmhome/approval')?>" class='btn btn-outline-warning my-3' role='button'>Back</a>
    ...
    <a class="btn btn-outline-danger my-3 ml-3" href="<?=base_url('gmhome/reject/'.$hist[0]['id_travel'])?>" role="button" >Reject</a>
    <a class="btn btn-outline-primary my-3 ml-3"  href="<?=base_url('gmhome/approve/'.$hist[0]['id_travel'])?>" role="button" >Approve</a>
</center>
    <?php }?>
</div>