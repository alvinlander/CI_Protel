...
<div class="container my-4" style='background: white; padding: 5px; width: 450px;'>
  ...
  <?php }else if ($this->session->flashdata('flush')){?>
    ...
    <form action='<?= base_url('managerhome/addperjalanan')?>' method='post' enctype='multipart/form-data'> 
    ...
    <button type="submit" class="btn btn-outline-primary btn-block" style="font-weight: bold;">Submit</button>
    </form>
    </div>
    </div>