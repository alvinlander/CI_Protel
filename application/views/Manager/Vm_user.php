  ...
  <?php foreach ($user as $us):?>
    <tr>
      ...
      <td>
        ...
        <a href="<?=base_url('Managerhome/delsweeper/'.$us['id_user'])?>" class='btn btn-outline-danger btn-sm'>Hapus</a>
      </td>
    </tr>
    <!-- Modal add user -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('Managerhome/addsweeper')?>" method="post">
...
<div class="modal fade" id="<?="edit".$us['id_user']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="<?=base_url('Managerhome/editsweeper/'.$us['id_user'])?>" method="post">
        <div class="form-group">
            <label for="fullname">Fullname</label>
