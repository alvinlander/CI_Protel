...
<?php if($hist == NULL){?>
    <div class="container my-3" style="background-color: white;">
        <center>
            ...
            <a href="<?= base_url('svmhome/history')?>" class='btn btn-outline-warning btn-lg my-3'>Back</a>
        </center>
    </div>
<?php } else{?>
    <div class="container my-3" style="background-color: white;">

        <a href="<?= base_url('svmhome/history')?>" class='btn btn-outline-warning my-3' role='button'>Back</a>
        <a class="btn btn-outline-danger my-3 ml-3" href="<?=base_url('svmhome/end_trip/'.$hist[0]['id_travel'])?>" role="button" >End Trip</a>
        ...
        <tr>
            ...
            <td>
                <a href="<?= base_url('svmhome/hapus_detail/'.$h['id_detail'])?>" class="btn btn-outline-danger btn-lg" style="float: right;">Hapus</a>
            </td>
            <?php endif;?>
        </tr>
        ...
        <div class="modal fade" id="exampleModal<?=$h['id_detail']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                ...
                <form action="<?= base_url('svmhome/edit_detail/'.$h['id_detail'])?>" enctype="multipart/form-data" method='post'>
    ...
    <?php if($trv['status'] == 0):?>
    <a href="<?= base_url('svmhome/save_changes/'.$h['id_travel'])?>" class="btn btn-outline-primary btn-lg my-3" style="font-weight: bold;" >Save Changes</a>
    <?php endif;?>
    <?php }?>
</div>